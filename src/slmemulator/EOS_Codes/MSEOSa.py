...
def main(Ls, Lv, zeta, xi, fileName):
    gam = 4.0
    gam1 = 2.0
...
if __name__ == "__main__":
    # print(sys.argv[1:])
    Ls, Lv, zeta, xi, fileName = sys.argv[1:]
    print("Running MSEOS code now with parameters:")
    print(f"Ls: {Ls}, Lv: {Lv}, zeta: {zeta}, xi: {xi}, fileName: {fileName}")
    main(float(Ls), float(Lv), float(zeta), float(xi), fileName)
